...
const lines = [
    {
        ...
        color: "green",
        stations: [
            { name: "Banashankari", id: "BSNK" },
            { name: "Chickpete", id: "CKPE" },
            { name: "Chikkabidarakallu", id: "JU" },
            { name: "Dasarahalli", id: "DSH" },
            { name: "Doddakallasandra", id: "KLPK" },
            { name: "Goraguntepalya", id: "YPI" },
            { name: "Jalahalli", id: "JLHL" },
            { name: "Jayanagar", id: "JYN" },
            { name: "Jayaprakash Nagar", id: "JPN" },
            { name: "Krishna Rajendra Market", id: "KRMT" },
            { name: "Konanakunte Cross", id: "APRC" },
            { name: "Lalbagh", id: "LBGH" },
            { name: "Madavara", id: "MA" },
            { name: "Mahalakshmi", id: "MHLI" },
            { name: "Mahakavi Kuvempu Road", id: "KVPR" },
            { name: "Manjunathanagara", id: "MJA" },
            { name: "Nagasandra", id: "NGSA" },
            { name: "National College", id: "NLC" },
            { name: "Peenya", id: "PEYA" },
            { name: "Peenya Industry", id: "PYID" },
            { name: "Rajajinagar", id: "RJNR" },
            { name: "Rashtreeya Vidyalaya Road", id: "RVR" },
            { name: "Mantri Square, Sampige Road", id: "SPGD" },
            { name: "Sandal Soap Factory", id: "SSFY" },
            { name: "Silk Institute", id: "APTS" },
            { name: "South End Circle", id: "SECE" },
    ...
    },
    {
        ...
        stations: [
            ...
            { name: "Attiguppe", id: "AGPP" },
            { name: "Baiyappanahalli", id: "BYPL" },
            { name: "Benniganahalli", id: "JTPM" },
            { name: "Krantivira Sangolli Rayanna Railway Station", id: "SRCS" },
            { name: "Challaghatta", id: "CLGA" },
            { name: "Cubbon Park", id: "CBPK" },
            { name: "Deepanjali Nagar", id: "DJNR" },
            { name: "Garudacharapalya", id: "GDCP" },
            { name: "Halasuru", id: "HLRU" },
            { name: "Hoodi", id: "DKIA" },
            { name: "Hopefarm Channasandra", id: "UWVL" },
            { name: "Sri Balagangadharanatha Swamiji Station, Hosahalli", id: "HSLI" },
            { name: "Indiranagar", id: "IDN" },
            { name: "Jnanabharathi", id: "BGUC" },
            { name: "Kadugodi Tree Park", id: "KDGD" },
            { name: "Krishnarajapura (K.R.Pura)", id: "KRAM" },
            { name: "Kengeri", id: "KGIT" },
            { name: "Kengeri Bus Terminal", id: "MLSD" },
            { name: "Kundalahalli", id: "KDNH" },
            { name: "Magadi Road", id: "MIRD" },
            { name: "Nadaprabhu Kempegowda Station, Majestic", id: "KGWA" },
            { name: "Mahatma Gandhi Road", id: "MAGR" },
            { name: "Mysuru Road", id: "MYRD" },
            { name: "Nallurhalli", id: "VDHP" },
            { name: "Pantharapalya–Nayandahalli", id: "NYHM" },
            { name: "Pattanagere", id: "PATG" },
            { name: "Pattandur Agrahara", id: "ITPL" },
            { name: "Rajarajeshwari Nagar", id: "RRRN" },
            { name: "Seetharamapalya", id: "VWIA" },
            { name: "Singayyanapalya", id: "MDVP" },
            { name: "Sir.M.Visvesvaraya Stn., Central College", id: "VSWA" },
            { name: "Swami Vivekananda Road", id: "SVRD" },
            { name: "Sri Sathya Sai Hospital", id: "SSHP" },
            { name: "Trinity", id: "TTY" },
            { name: "Dr. B. R. Ambedkar Station, Vidhana Soudha", id: "VDSA" },
            { name: "Vijayanagar", id: "VJN" },
        ]
    },
];
